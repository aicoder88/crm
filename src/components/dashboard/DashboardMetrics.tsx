...
export function DashboardMetrics({ customerCount }: DashboardMetricsProps) {
    return (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 animate-fade-in-up delay-100">
            <Card className="glass border-white/5 relative overflow-hidden group hover:scale-105 transition-transform duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
                ...
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
                    <CardTitle className="text-sm font-medium text-muted-foreground group-hover:text-white transition-colors">Total Customers</CardTitle>
                    <Users className="h-4 w-4 text-purple-400 drop-shadow-[0_0_5px_rgba(168,85,247,0.5)]" />
                </CardHeader>
            ...
            <Card className="glass border-white/5 relative overflow-hidden group hover:scale-105 transition-transform duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
                ...
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
                    <CardTitle className="text-sm font-medium text-muted-foreground group-hover:text-white transition-colors">Active Deals</CardTitle>
                    <DollarSign className="h-4 w-4 text-teal-400 drop-shadow-[0_0_5px_rgba(20,184,166,0.5)]" />
                </CardHeader>
                <CardContent className="relative z-10">
            ...
            <Card className="glass border-white/5 relative overflow-hidden group hover:scale-105 transition-transform duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
                ...
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
                    <CardTitle className="text-sm font-medium text-muted-foreground group-hover:text-white transition-colors">Products</CardTitle>
                    <Package className="h-4 w-4 text-pink-400 drop-shadow-[0_0_5px_rgba(236,72,153,0.5)]" />
                </CardHeader>
                <CardContent className="relative z-10">
                    <div className="text-3xl font-bold text-white drop-shadow-lg">0</div>
            ...
            <Card className="glass border-white/5 relative overflow-hidden group hover:scale-105 transition-transform duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
                ...
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
                    <CardTitle className="text-sm font-medium text-muted-foreground group-hover:text-white transition-colors">Recent Activity</CardTitle>
                    <Activity className="h-4 w-4 text-orange-400 drop-shadow-[0_0_5px_rgba(249,115,22,0.5)]" />
                </CardHeader>
                <CardContent className="relative z-10">
                    <div className="text-3xl font-bold text-white drop-shadow-lg">0</div>
